...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!csrf_form_ok()) {
        ...
        if ($result === 'ok') {
            ...
            $error = 'Confirme seu e-mail antes de entrar. Você pode solicitar um novo link abaixo.';
        } else {
...
<?php else: ?>
  <form class="card" method="POST" autocomplete="on" data-supabase-login>
    ...
    <div class="footer">Primeira vez aqui? <a href="register.php">Criar conta</a> · <a href="resend-verification.php">Reenviar confirmação</a></div>
  </form>
